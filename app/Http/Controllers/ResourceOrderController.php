...
class ResourceOrderController extends Controller
{
    ...
    public function show(Request $request, ResourceOrder $resource_order): Response
    {
        ...
        $reconciliation = ResourceOrderReconciliation::summarize($resource_order, $linkedDocuments, $deliveries);
    ...
    {
        $status = ResourceOrderReconciliation::resolveLifecycleStatus($reconciliation, $confirmations);
