...
<body>
    ...
    <div class="page" style="text-align: center; padding-top: 120px;">
        ...
        @endif
        <div class="cover-title">{{ $content['cover_title'] }}</div>
        <div class="cover-subtitle">{{ $content['cover_subtitle'] }}</div>
    ...
    <div class="page" style="text-align: center; padding-top: 60px;">
        <h1>{{ $content['closing_title'] }}</h1>
        <p class="muted">{{ $content['closing_text'] }}</p>
