    ...
    <AppLayout title="Taskuri pe etapa">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">{{ pluralize(tasks.total, 'task inregistrat', 'taskuri inregistrate') }}</p>
            </div>
        ...
        <EmptyState
            ...
            :icon="ListBulletIcon"
            title="Nu exista taskuri pe etapa"
            description="Adauga primul task operational pentru o etapa."
        >
