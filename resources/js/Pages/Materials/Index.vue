<template>
    <AppLayout title="Materiale">
        ...
        <div v-if="materials.data.length === 0" class="bg-white rounded-xl border border-gray-200 p-16 text-center">
            <div class="text-5xl mb-4">📦</div>
            <h3 class="text-lg font-semibold text-gray-700 mb-2">Nu exista materiale</h3>
            <p class="text-gray-400 text-sm mb-6">Adauga primele materiale in catalog.</p>
