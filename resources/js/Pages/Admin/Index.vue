            ...
            <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div v-else class="mt-6">
                    ...
                    <form class="mt-5 space-y-4 max-w-xl" @submit.prevent="saveSettings">
                        ...
                        <button type="submit" class="rounded-xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800 disabled:opacity-60" :disabled="settingsForm.processing">
                            Salveaza setarile
                        </button>
                    </form>
                </div>
